...
| <a name="input_metric_namespace"></a> [metric_namespace](#input\_metric_namespace) | The namespace for the alarm's associated metric. See docs for the list of namespaces. See docs for supported metrics. | `string` | `null` | no |
